...
//  iOS-Calculator
//
//  Created by Aranza Manriquez Alonso on 10/07/23.
//
...
final class HomeViewController: UIViewController {
    ...
    private var operating = false        //Indicar si se ha seleccionado una operacion
    ...
    @IBAction func operatoraPercentAction(_ sender: UIButton) {
